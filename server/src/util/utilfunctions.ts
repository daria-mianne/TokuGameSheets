...
export function addRoute(app: Express, method: RequestMethod, apiVersion: string, endpoint: string, routeHandler: (req: Request, res: Response) => Promise<void>): void {
    let appMethod;
    switch (method) {
        case 'post':
            appMethod = app.post;
 ...
 */
function errorCatcher(routeHandler: (req: Request, res: Response) => Promise<void>): (req: Request, res: Response) => Promise<void> {
