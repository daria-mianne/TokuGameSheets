        ...
        <form id='AccountCreation'>
            <div style={{
                ...
                <label>
                    ...
                    <input id='passwordMain' type='password' maxLength={100} required={true} onInput={() => checkSame(setPasswordsMatch, getElementText('passwordMain'), getElementText('passwordConfirm'))} />
                </label>
                <label>
                    Confirm Password:&nbsp;
                    {
                    ...
                    <input id='passwordConfirm' type='password' maxLength={100} required={true} onInput={() => checkSame(setPasswordsMatch, getElementText('passwordMain'), getElementText('passwordConfirm'))} />
                </label>
                ...
                <label>
                    ...
                    <input id='emailMain' type='text' maxLength={500} required={false} onInput={() => checkSame(setEmailsMatch, getElementText('emailMain'), getElementText('emailConfirm'))} />
                </label>
                <label>
                    ...
                    <input id='emailConfirm' type='text' maxLength={500} required={getElementText('emailMain') !== ''} onInput={() => checkSame(setEmailsMatch, getElementText('emailMain'), getElementText('emailConfirm'))} />
                </label>
